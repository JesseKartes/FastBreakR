...
box_score_types <- list(
  Traditional = list(
    ...
    list_name = "boxScoreTraditional"
  ),
  Advanced = list(
    endpoint = "boxscoreadvancedv3",
    list_name = "boxScoreAdvanced"
  ),
  Misc = list(
    endpoint = "boxscoremiscv3",
    list_name = "boxScoreMisc"
  ),
  Scoring = list(
    endpoint = "boxscorescoringv3",
    list_name = "boxScoreScoring"
  ),
  Usage = list(
    endpoint = "boxscoreusagev3",
    list_name = "boxScoreUsage"
  ),
  Factors = list(
    endpoint = "boxscorefourfactorsv3",
    list_name = "boxScoreFourFactors"
  ),
  Tracking = list(
    endpoint = "boxscoreplayertrackv3",
    list_name = "boxScorePlayerTrack"
  ),
  Defensive = list(
    endpoint = "boxscoredefensivev2",
    list_name = "boxScoreDefensive"
  ),
  Hustle = list(
    endpoint = "boxscorehustlev2",
    list_name = "boxScoreHustle"
  )
)
...
#' @export
nba_box_scores_matchups <- function(game_ids,
                                    batch_size = 100,
                                    pause_seconds = 15) {
      ...
      tryCatch(
        {
          ...
          params <- generate_params_box_scores(.x)
      ...
      tryCatch(
        {
          ...
          data_frames <- map(measure_type, function(measure) {
            ...
            params <- generate_params_box_scores(game_id)
            data <- get_data(url, headers, params)
